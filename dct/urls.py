...
urlpatterns = [
    ...
    path('update_dct/<str:slug>/', DataCollectTerminalUpdate.as_view(), name='update_dct_url'),
    path('delete_dct/<str:slug>/', DataCollectTerminalDeleteView.as_view(), name='delete_dct_url'),
